...
const UE = require("ue"),
	...
	QuickTeamSwap_1 = require("../Manager/QuickTeamSwap"), // [QuickTeamSwap]
	InputSettings_1 = require("../InputSettings/InputSettings"), // [QuickTeamSwap]
...
class InputController extends ControllerBase_1.ControllerBase {
	...
	static InputAxis(t, n) {
		// [QuickTeamSwap] start
		QuickTeamSwap_1.QuickTeamSwap.HandleKeyInputs();
		// [QuickTeamSwap] end
