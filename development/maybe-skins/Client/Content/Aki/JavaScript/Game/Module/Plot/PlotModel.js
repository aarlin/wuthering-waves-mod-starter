...
class PlotModel extends ModelBase_1.ModelBase {
	...
	ShowCenterTextForTeleport(e) {
		var t;
		this.PlayFlow &&
			(t =
				PlotController_1.PlotController.GetTalkItemsOfCenterTextForTeleport()) &&
			((this.CenterText.Text =
				PublicUtil_1.PublicUtil.GetFlowConfigLocalText(t)),
	...
	SwitchCameraMode(e) {
		(this.PlotConfig.CameraMode = e), this.Q$i();
	}
	Q$i(e = !1) {
	...
	CheckOptionCondition(e, t) {
		...
		let o = !1;
		return "PreOption" === e.PreCondition.Type ? this.z$i(e, t) : o;
	}
	z$i(e, t) {
		let o = !0;
	...
	InitPlotTemplate() {
		...
		if (
			...
			for (const e of JSON.parse(t).List) this.k$i.set(e.Id, e);
	}
	InitMontageConfig() {
		this.jZ = new Map();
		let e = (0, PublicUtil_1.getConfigPath)(
	...
	eYi() {
		...
		if (
			...
			for (const e of JSON.parse(t).Montages) this.F$i.set(e.Id, e);
	}
	GetOverlayAbpMontageConfig(e) {
		if (PublicUtil_1.PublicUtil.UseDbConfig()) {
			if ((this.F$i || (this.F$i = new Map()), !this.F$i.get(e))) {
				var t =
		...
		return this.F$i.get(e);
	}
	GetPlotTemplateConfig(e) {
		if (PublicUtil_1.PublicUtil.UseDbConfig()) {
			if ((this.k$i || (this.k$i = new Map()), !this.k$i.get(e))) {
				var t =
