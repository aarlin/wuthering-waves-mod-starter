...
class CreatureController extends ControllerBase_1.ControllerBase {
	...
	static bVs(e, t, r, o) {
			...
			(i =
				(!i &&
					(r === Protocol_1.Aki.Protocol.WBs.Proto_RemoveTypeNormal &&
						n.GetEntityType() !== Protocol_1.Aki.Protocol.wks.Proto_Npc &&
						n.GetEntityType() !== Protocol_1.Aki.Protocol.wks.Proto_SceneItem &&
						n.GetEntityType() !== Protocol_1.Aki.Protocol.wks.Proto_Animal &&
						(i = !0),
					!e.Entity.Active)) ||
				i)
		)
		...
		if (n.GetEntityType() === Protocol_1.Aki.Protocol.wks.Proto_Animal) {
	...
	static CreateEntity(e, t = "Default") {
		var r,
			...
			n = e.cVn;
		return n === Protocol_1.Aki.Protocol.wks.Proto_Npc &&
	...
	static f0r(e) {
		...
		return t.GetEntityType() === Protocol_1.Aki.Protocol.wks.Proto_Custom || r
			? (Log_1.Log.CheckInfo() &&
					Log_1.Log.Info(
						"Entity",
						3,
