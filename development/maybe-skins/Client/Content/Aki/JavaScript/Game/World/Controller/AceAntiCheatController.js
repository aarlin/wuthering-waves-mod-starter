...
class AceAntiCheatController extends ControllerBase_1.ControllerBase {
	...
	static OnTick(t) {
		...
		if (
			...
			for (const r of this.hEa.keys()) {
				...
				i &&
					((o = this.hEa.get(r).$Ra).push(i), o.length > POSTICKCOUNT) &&
					(this.aEa = !1);
			}
		}
	}
	...
	static yEa(t) {
		...
		this.uEa !== t
			...
			: (((e = Protocol_1.Aki.Protocol.nRa.create()).mEa =
					MathUtils_1.MathUtils.BigIntToLong(t)),
			...
			for (const i of (this.BEa = t)) {
				this.hEa || (this.hEa = new Map()),
					this.hEa.get(i.CreatureDataId) ||
						(((e = Protocol_1.Aki.Protocol.xwa.create()).bEa = i.RoleId),
	...
	static wEa(t, e) {
		if (this.BEa && this.hEa) {
			var o,
				i = Protocol_1.Aki.Protocol.aRa.create(),
				r =
	...
	static $Ea(t) {
		...
		this.QEa !== t
			...
			: (this.KEa &&
				...
				((e = Protocol_1.Aki.Protocol.lRa.create()).mEa =
					MathUtils_1.MathUtils.BigIntToLong(t)),
	...
	static XEa(t) {
		...
		0 < this.YEa
			...
			: ((this.YEa = t),
				(this.cEa = Time_1.Time.WorldTime),
				((e = Protocol_1.Aki.Protocol.uRa.create()).mEa =
					MathUtils_1.MathUtils.BigIntToLong(t)),
				(e.dEa = TimeUtil_1.TimeUtil.DateFormat2(new Date())),
				(o = this.YNr())
					? ((e.CEa = o[0] ? this.gEa(o[0]) : void 0),
	...
	static JEa(t) {
		...
		this.YEa !== t
			...
			: ((this.YEa = -1n),
				((e = Protocol_1.Aki.Protocol.dRa.create()).mEa =
					MathUtils_1.MathUtils.BigIntToLong(t)),
				(e.IEa = TimeUtil_1.TimeUtil.DateFormat2(new Date())),
				(e.TEa = Time_1.Time.WorldTime - this.cEa),
				(e.LEa = this.nun),
...
(exports.AceAntiCheatController = AceAntiCheatController),
	...
	(AceAntiCheatController.ReportDataRequest = () => {
		var t, e;
    // MOD: Stop reporting data
		!Net_1.Net.IsServerConnected() &&
			((t = Protocol_1.Aki.Protocol.rRa.create()),
