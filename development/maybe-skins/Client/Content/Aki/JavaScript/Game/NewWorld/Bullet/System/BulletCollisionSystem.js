...
class BulletCollisionSystem extends BulletSystemBase_1.BulletSystemBase {
	...
	ajo(t, e, o) {
		...
		t?.IsInit &&
			(i = t.Entity) &&
			(l = i.GetComponent(0)) &&
			((l = l.GetEntityType()) === Protocol_1.Aki.Protocol.wks.Proto_Player ||
				l === Protocol_1.Aki.Protocol.wks.Proto_Monster ||
				l === Protocol_1.Aki.Protocol.wks.Proto_Vision) &&
			...
			if (
				...
				if ((o.EntityHandle = l)?.Valid) {
					var i = (l = l.Entity).GetComponent(0),
						a = i?.GetEntityType();
					if (a === Protocol_1.Aki.Protocol.wks.Proto_SceneItem)
						return (o.Type = 3), o;
					if (a === Protocol_1.Aki.Protocol.wks.Proto_Npc)
						return (o.Type = 5), o;
					if (
						a === Protocol_1.Aki.Protocol.wks.Proto_Animal &&
						2 === i.GetEntityCamp()
					)
						return (o.Type = 6), o;
