...
class TargetDamageStatistics {
	constructor(t) {
		...
		(this.JB = e === Protocol_1.Aki.Protocol.HBs.Proto_Monster),
			(this.XHt = e === Protocol_1.Aki.Protocol.HBs.Proto_Player),
			(this.Mne = 0),
			(this.PKo = ""),
			this.JB
...
class CombatDataBase {
	...
	static GetEntityConfigName(t) {
		if ((t = EntitySystem_1.EntitySystem.Get(t))) {
			...
			if (i === Protocol_1.Aki.Protocol.HBs.Proto_Monster)
	...
	ParseToString() {
		var [t, e] = CombatDataBase.GetEntityConfigNameAndSkillName(
			...
			a =
				...
				a.GetCurrentValue(Protocol_1.Aki.Protocol.KBs.Tkn));
		return StringUtils_1.StringUtils.Format(
