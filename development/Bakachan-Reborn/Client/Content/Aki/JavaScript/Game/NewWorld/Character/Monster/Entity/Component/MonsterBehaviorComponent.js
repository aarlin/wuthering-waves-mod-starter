...
let MonsterBehaviorComponent = class extends EntityComponent_1.EntityComponent {
	constructor() {
		super(...arguments),
			(this.Hte = void 0),
			(this.Xte = void 0),
			...
			(this.rin = (t, e) => {
				var o = this.Hte.ActorLocationProxy,
					n = (Protocol_1.Aki.Protocol.jNn.create().M3n = o);
				CombatMessage_1.CombatNet.Call(24697, n),
					e &&
						(this.nin(!0),
