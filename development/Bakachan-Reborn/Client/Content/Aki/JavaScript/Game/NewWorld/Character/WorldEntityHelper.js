...
const UE = require("ue"),
	...
	PawnInteractNewComponent_1 = require("../Pawn/Component/PawnInteractNewComponent_New"),
	...
	CharacterSkillCdComponent_1 = require("./Common/Component/Skill/CharacterSkillCdComponent_New"),
	...
	static CreateWorldEntity(e) {
		...
		switch (n.cVn) {
			...
			case Protocol_1.Aki.Protocol.HBs.Proto_Npc:
				...
				if (o) (e.ComponentsKey = t), this.Qir(e);
				else {
