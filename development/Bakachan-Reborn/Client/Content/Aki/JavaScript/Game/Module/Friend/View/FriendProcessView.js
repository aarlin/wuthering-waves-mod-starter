...
class FriendProcessView extends UiViewBase_1.UiViewBase {
	constructor() {
		super(...arguments),
			...
			(this.g6t = void 0),
			(this.J6t = (e, t, r) => (
				(t = new PersonalOptionItem_1.PersonalOptionItem(t)).Refresh(e, !1, r),
				1 === e
					? (this.j6t = t)
					: 2 === e
						? (this.W6t = t)
	...
	r8t() {
		...
		t && "" !== t
			...
			: e.GetSelectedPlayerOrItemInstance()?.PlayerId !==
				...
				? r?.SetText("")
				: LguiUtil_1.LguiUtil.SetLocalText(r, "EmptySign");
	}
	w6t() {
		var e = ModelManager_1.ModelManager.FriendModel,
			t = e.FilterState,
		...
		this.C4e(),
			...
			this.W6t.GetRootItem().SetUIActive(
				(("FriendView" === r || "FriendSearchView" === r) && 1 === t) ||
					2 === t,
			),
			this.X6t.GetRootItem().SetUIActive(!0),
			("FriendView" !== r &&
				"FriendSearchView" !== r &&
				"FriendBlackListView" !== r) ||
				this.z6t(),
