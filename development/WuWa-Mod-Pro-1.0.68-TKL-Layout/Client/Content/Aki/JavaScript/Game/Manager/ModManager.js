...
class ModManager {
  ...
  static ModStart() {
    ...
    this.AddKey("ShopMultiplier", "Semicolon");
    this.AddToggle("UIDChanger", "Apostrophe");
    this.AddToggle("AutoLoot", "Comma");
    this.AddToggle("AutoDestroy", "Period");
    this.AddToggle("HideDamage", "Slash");
  }
