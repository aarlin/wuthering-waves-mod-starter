...
class ModManager {
  ...
  static ModStart() {
    ...
    this.AddToggle("AutoLoot", "Period");
    this.AddToggle("AntiDither", "Slash");
  ...
  static listenModsToggle() {
    ...
    this.listenMod("AutoLoot", "Period", "AutoLoot");
    this.listenMod("AntiDither", "Slash", "AntiDither");
  ...
  static ShowMenu() {
    ...
    const cheatToggleStates = [
      ...
      this.FuncState(this.Settings.AutoLoot, ModTranslation("AutoLoot[Period]")),
      this.FuncState(this.Settings.AntiDither, ModTranslation("AntiDither[Slash]"))
    ];
