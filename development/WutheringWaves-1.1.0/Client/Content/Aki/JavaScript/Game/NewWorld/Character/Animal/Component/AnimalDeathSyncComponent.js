		...
		super(...arguments),
			...
			(this.joe = (e) => {
				e.ReBulletData.Base.DamageId === BigInt(0) ||
					this.Ste.ContainsTagById(501201e3) ||
					this.Ste.ContainsTagById(1008164187) ||
			...
			(this.ExecuteDeath = () =>
				...
				!0)),
			(this.PlayDieAnimation = () => {
				this.Ste.ContainsTagById(-1943786195) || !this.MontageComponent?.Valid
					? this.OnDeathEnded()
					: this.Ste.ContainsTagById(1961456719)
