...
class PointInPolygonTest {
	constructor() {
		(this.CLi =
			...
			(this.gLi = new BinSet()),
			(this.fLi = new Array()),
			(this.pLi = Vector2D_1.Vector2D.Create());
	}
	InitSpline() {
		var t = this.CLi;
		this.IsSplineInit ||
			ResourceSystem_1.ResourceSystem.LoadAsync(t, UE.Class, (t) => {
				this.owe(t), (this.IsSplineInit = !0), this.nwe(this.fLi, 30, this.gLi);
			});
	}
	owe(t) {
		...
		for (let t = 0, e = i; t < e; t++) {
			...
			this.fLi.push(new Vector2D_1.Vector2D(s.X, s.Y));
		}
		t.K2_DestroyActor();
	}
	swe(t, e, r, i, s) {
