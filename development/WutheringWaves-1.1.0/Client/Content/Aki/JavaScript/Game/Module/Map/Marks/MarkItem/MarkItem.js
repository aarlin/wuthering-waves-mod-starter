...
class MarkItem {
	constructor(t, e, i, s = 1) {
		(this.MapType = 2),
			...
			(this.IsOutOfBound = !1),
			(this.IsInAoiRange = !1),
			(this.aTi = Vector_1.Vector.Create()),
	...
	get UiPosition() {
		return this.WorldPosition
			? MapUtil_1.MapUtil.WorldPosition2UiPosition(this.WorldPosition, this.aTi)
	...
	set IsInAoiRange(t) {
		(this.uTi = t) ? this.gTi() : this.ClearView();
	}
	gTi() {
		this.View ||
			(this.IsCanShowView &&
				...
				(this.OnCreateView(),
				this.InnerView?.InitializeMarkItemViewAsync().finally(void 0)));
	}
	ClearView(t = !1) {
		!this.InnerView ||
	...
	set IsTracked(t) {
		var e = this.cTi;
		(this.cTi = t) && this.gTi(),
			e !== this.cTi && (t ? this.OnStartTrack() : this.OnEndTrack());
	}
	UpdateTrackState() {
	...
	get IsCanShowViewIntermediately() {
		return this.dTi && this.fTi;
	}
	get IsCanShowView() {
		return this.IsCanShowViewIntermediately || this.IsCanShowViewFinally;
	}
	set IsCanShowView(t) {
		this.dTi && !t && (this.dTi = t), (this.dTi = t) && this.fTi && this.gTi();
	}
	CheckCanShowView() {
