...
class DamageInfo {
    constructor() {
        this.Damage = 0, this.ElementId = 0, this.DamagePosition = void 0, this.IsOwnPlayer = !1, this.IsCritical = !1, this.IsCure = !1, this.DamageTextId = 0, this.DamageText = ""
    }
}
...
class DamageUiManager {
    ...
    static ApplyDamage(e, i, t, r, g, n, o = -1, s = "") {
        if (DamageUiManager.H2t && r.Active && !(o < 0 || 1 === o && n && 0 === e)) {
            var m = ModelManager_1.ModelManager.SceneTeamModel.GetCurrentEntity;
            if (m) {
                m = m.Id === r.Id;
                let a = void 0;
                (a = 0 < this.j2t.length?this.j2t.pop() : new DamageInfo).Damage = e, a.ElementId = i, a.DamagePosition = t, a.IsOwnPlayer = m, a.IsCritical = g, a.IsCure = n, a.DamageTextId = o, a.DamageText = s, this.W2t.Push(a)
            }
        }
    }
    static K2t(a) {
        ...
        var e, i, t, r;
        DamageUiManager.H2t && (e = Math.floor(Math.abs(a.Damage)), (i = DamageUiManager.Q2t(a.ElementId, a.IsCure, a.Damage, a.DamageTextId)) < 0?Log_1.Log.CheckInfo() && Log_1.Log.Info("Battle", 8, "[DamageText]产生伤害飘字时，伤害飘字Id无效", ["textId", i], ["elementId", a.ElementId], ["bCure", a.IsCure], ["damageTextId", a.DamageTextId]) : (this.DamagePositionCache.DeepCopy(a.DamagePosition), (t = this.GetDamageViewData(i))?(r = this.ProjectWorldLocationToScreenPosition(a.DamagePosition)) && DamageUiManager.X2t(e, this.DamagePositionCache, r, t, a.IsCritical, a.IsCure, a.IsOwnPlayer, a.DamageText) : Log_1.Log.CheckWarn() && Log_1.Log.Warn("Battle", 8, "找不到对应的伤害飘字配置", ["伤害飘字Id", i])))
    }
    static Tick(a) {
    ...
    static Q2t(a, e, i, t = -1) {
        let r = -1;
        return r = t && -1 !== t?t : 0 === i?BattleUiDefine_1.IMMUNITY_DAMAGE_TEXT_ID : 0 < a?a : e?BattleUiDefine_1.CURE_DAMAGE_TEXT : BattleUiDefine_1.ATK_DAMAGE_TEXT
    }
    ...
    static X2t(a, e, i, t, r = !1, g = !1, n = !1, o = "") {
        let s = void 0;
        return 0 < this.V2t.length?s = this.V2t.pop() : ((s = new DamageView_1.DamageView).Init(), this.TotalDamageViewNum++), this.$2t.add(s), s.InitializeData(a, e, i, t, r, g, n, o), s
    }
    ...
    static OnLeaveLevel() {
        ...
        DamageUiManager.V2t.length = 0, DamageUiManager.TotalDamageViewNum = 0, DamageUiSequencePool_1.DamageUiSequencePool.Clear(), DamageUiManager.W2t.Clear(), DamageUiManager.j2t.length = 0
    }
    static Clear() {}
}(exports.DamageUiManager = DamageUiManager).W2t = new Queue_1.Queue, DamageUiManager.j2t = [], DamageUiManager.TotalDamageViewNum = 0, DamageUiManager.$2t = new Set, DamageUiManager.V2t = new Array, DamageUiManager.F2t = new Map, DamageUiManager.H2t = !0, DamageUiManager.MinDamageOffsetScale = 0, DamageUiManager.MaxDamageOffsetScale = 0, DamageUiManager.MinDamageOffsetDistance = 0, DamageUiManager.MaxDamageOffsetDistance = 0, DamageUiManager.DamagePositionCache = void 0, DamageUiManager.k2t = void 0, DamageUiManager.Y2t = (0, puerts_1.$ref)(void 0);
